...
DROP DATABASE IF EXISTS majibo;
CREATE DATABASE majibo;
USE majibo;
...
"AA01-017",
"NBA 2K17",  
"The excitement from the roar of the crowd wouldn't stop the players on the court", 
"Paul George", 
"aa01-017.jpg",
1003,
50.45 , 
...
-- running this script!
GRANT DELETE,SELECT,INSERT,UPDATE ON majibo.* TO 'majibo'@'localhost' IDENTIFIED BY 'obscure';
