...
$test_query = "select * from inventory where item_description like '%".$_GET['searchstring']."%'";
...
'<td><form action ="products_buy.php?item_code=' . $row[ 'item_code' ] ,'&item_price=' . $row[ 'item_price' ] . '" method="post"> <button type="submit"> Buy </button> </form></td>',
